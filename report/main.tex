...
%TODO one sentence to say what kind of functions and properties we needed to ensure

\section{Encoder} %TODO

\subsection{"Encodability"}
%TODO how canEncode is defined, canEncodeCharUniquely and need a InnerNode

\subsection{Encode a character}
%TODO present postcondition, implementation and canEncodeUniquelyImpliesWithExactlyOneChild

\subsection{Encode a string}
%TODO present postconditon, implementatio and give intuition of all lemmas called
