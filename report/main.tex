...
We represent the strings (input of the pipeline) as \lstinline{List[Char]} as it is easier to define recursion using lists rather than  \lstinline{String} type directly. Similarily we define the encoded binary string as  \lstinline{List[Boolean]}.
